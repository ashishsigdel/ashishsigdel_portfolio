...
export default function WorkCard({ work, index }: WorkProps) {
  return (
    <motion.div
      ...
      className={`w-full border border-gray-700 px-4 py-8 md:p-8 rounded-ss-md rounded-ee-md overflow-hidden relative transition-all duration-300 ease-in-out shadow-lg bg-white dark:bg-gray-900 ${
        index % 2 !== 0
